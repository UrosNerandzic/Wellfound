...
export default async function Page({ params, searchParams }) {
  ...
  const job = filters.length > 0 ? decodeFilterValue(filters[0]) : null;
  const city = filters.length > 1 ? decodeFilterValue(filters[1]) : null;
    ...
    <>
      ...
      <div className="jobGroup">
        <div className="jobSearchBar">
          <FilterSection job={job} city={city} />
          <ResultSearchBar />
        </div>
